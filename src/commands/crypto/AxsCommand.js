...
module.exports = class AxsCommand extends BaseCommand {
  constructor() {
    super("axs", "crypto", []);
  }
  ...
  async run(client, message, args) {
    let axsData = async () => {
      ...
      let axsData = res.data;
      return axsData;
    };

    let axs = await axsData();
    ...
    const axsEmbed = new Discord.MessageEmbed()
      ...
      .addField(
        ...
        `${Intl.NumberFormat("en-PH", {
          style: "currency",
          currency: "PHP",
        }).format(axs.market_data.low_24h.php)} / ${Intl.NumberFormat("en-PH", {
          style: "currency",
          currency: "PHP",
